...
class ImagePickManager: NSObject {
    
    weak var vc: UIViewController?
    
    var pickCompletionHanlder: ((UIImage)->Void)?

    static let sharedInstance = ImagePickManager()
...
extension ImagePickManager: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
extension ImagePicker where Self: UIViewController {
    func pickImage() {
        ImagePickManager.sharedInstance.vc = self
        ImagePickManager.sharedInstance.pickCompletionHanlder = didPickImage
        ImagePickManager.sharedInstance.pickImage()
    }
}
